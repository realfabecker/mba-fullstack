...
import { getProfile, GetProfileResponse } from "@/api/get-profile.ts";
import {
...
export function AccountMenu() {
  ...
  }: { data: GetProfileResponse } = useQuery<GetProfileResponse>({
    queryKey: ["profile"],
    queryFn: getProfile,
    staleTime: Infinity,
  });
  ...
  }: { data: GetManagedRestaurantResponse } =
